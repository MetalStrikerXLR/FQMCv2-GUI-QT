...
#include "ui_ltankwidget.h"

LTankWidget::LTankWidget(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::LTankWidget)
{
    ui->setupUi(this);
}

LTankWidget::~LTankWidget()
{
    delete ui;
}

void LTankWidget::paintEvent(QPaintEvent *e)
{
    ...
    //////////////////////////////////////////////////////
    QPoint p1; p1.setX(10); p1.setY(150);
    QPoint p2; p2.setX(10); p2.setY(250);
    QPoint p3; p3.setX(270); p3.setY(250);
    QPoint p4; p4.setX(270); p4.setY(10);

    QPoint hp1; hp1.setX(10); hp1.setY(10);
    QPoint hp2; hp2.setX(10); hp2.setY(150);
...
void LTankWidget::setPercentage(int value)
{
    percent = value;
}
